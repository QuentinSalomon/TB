...
namespace Framework
{
    [ConceptView(typeof(UserControlFileManagement))]
    [IntlConceptName("Framework.FileManagement.Name", "FileManagement")]
    [ConceptSmallImage(typeof(FileManagement), "/Images/FileManagement32x32.png")]
    [ConceptLargeImage(typeof(FileManagement), "/Images/FileManagement64x64.png")]
    public class FileManagement : ConceptComponent
    {
        #region Propriétés

        [ConceptSerialized]
        [ConceptViewVisible]
        [IntlConceptName("Framework.FileManagement.DefaultPathLoadFile", "DefaultPathLoadFile")]
        ...
        [ConceptSerialized]
        [ConceptViewVisible]
        [IntlConceptName("Framework.FileManagement.PathSaveFile", "PathSaveFile")]
